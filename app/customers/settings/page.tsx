  ...
  if (!session) {
    return (
      <div className="p-6 text-center">
        ...
        <Link href="/" className="px-4 py-2 bg-[#D3628B] text-white rounded hover:bg-[#c0547a]">
          Go to Login
        </Link>
      </div>
    );
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-40 h-40 rounded-full overflow-hidden mb-4 border-2 border-[#D3628B]">
              <Image 
                src={profile.image} 
                alt="Profile" 
                fill
